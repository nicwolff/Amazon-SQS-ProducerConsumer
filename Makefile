# This Makefile is for the Amazon::SQS::ProducerConsumer extension to perl.
#
...
#     VERSION_FROM => q[lib/Amazon/SQS/ProducerConsumer/Base.pm]
#     clean => { FILES=>q[Amazon-SQS-ProducerConsumer-*] }
...
NAME_SYM = Amazon_SQS_ProducerConsumer
VERSION = 0.01
...
MAKE = make
FULLEXT = Amazon/SQS/ProducerConsumer
BASEEXT = ProducerConsumer
PARENT_NAME = Amazon::SQS
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Amazon/SQS/Consumer.pm \
	lib/Amazon/SQS/Producer.pm \
	lib/Amazon/SQS/ProducerConsumer/Base.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Amazon/SQS
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Amazon/SQS
...
TO_INST_PM = lib/.DS_Store \
	lib/Amazon/.DS_Store \
	lib/Amazon/SQS/.DS_Store \
	lib/Amazon/SQS/Consumer.pm \
	lib/Amazon/SQS/Producer.pm \
	lib/Amazon/SQS/ProducerConsumer/Base.pm

PM_TO_BLIB = lib/Amazon/.DS_Store \
	blib/lib/Amazon/.DS_Store \
	lib/Amazon/SQS/ProducerConsumer/Base.pm \
...
DISTNAME = Amazon-SQS-ProducerConsumer
DISTVNAME = Amazon-SQS-ProducerConsumer-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Amazon/SQS/ProducerConsumer/Base.pm $(INST_MAN3DIR)/Amazon::SQS::ProducerConsumer::Base.$(MAN3EXT) \
	  lib/Amazon/SQS/Producer.pm $(INST_MAN3DIR)/Amazon::SQS::Producer.$(MAN3EXT) \
	  lib/Amazon/SQS/Consumer.pm $(INST_MAN3DIR)/Amazon::SQS::Consumer.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Amazon-SQS-ProducerConsumer-* blib 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Amazon/.DS_Store blib/lib/Amazon/.DS_Store \
	  lib/Amazon/SQS/ProducerConsumer/Base.pm blib/lib/Amazon/SQS/ProducerConsumer/Base.pm \
	  lib/Amazon/SQS/Producer.pm blib/lib/Amazon/SQS/Producer.pm \
	  lib/Amazon/SQS/Consumer.pm blib/lib/Amazon/SQS/Consumer.pm \
	  lib/Amazon/SQS/.DS_Store blib/lib/Amazon/SQS/.DS_Store \
